...
const STYLE_FILES = ['base.css', 'layout.css', 'forms.css', 'components.css', 'tables.css', 'rollout.css', 'segments.css', 'segment-list.css', 'segment-create.css', 'segment-attach.css'] as const;
